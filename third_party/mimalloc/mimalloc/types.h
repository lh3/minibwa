...
// Debug and statistics are disabled for release builds
#define MI_DEBUG 0
#define MI_STAT 0

// Reserve extra padding at the end of each block to be more resilient against heap block overflows.
#if !defined(MI_PADDING) && (MI_SECURE>=3 || (MI_TRACK_VALGRIND || MI_TRACK_ASAN || MI_TRACK_ETW))
#define MI_PADDING  1
#endif
...
// A first-class heap (mi_heap_t is typedef'd in mimalloc.h)
